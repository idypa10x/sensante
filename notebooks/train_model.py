...
patients_fictifs = [
    {'age': 10, 'sexe': 'M', 'temperature': 36.8, 'tension_sys': 110,
    ...
    {'age': 68, 'sexe': 'M', 'temperature': 38.5, 'tension_sys': 130,
     'toux': True, 'fatigue': True, 'maux_tete': False, 'region': 'Kaolack'},
]
...
for i, p in enumerate(patients_fictifs):
    ...
    print(f"Patient {i+1} ({p['sexe']}, {p['age']}ans, {p['temperature']}°C) => {diagnostic} ({proba:.1%})")